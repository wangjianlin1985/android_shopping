...
<table width='100%' cellspacing='1' cellpadding='3' class="tablewidth">
  ...
  <tr>
    ...
    <td width=70%><input id="orderInfo.totalMoney" name="orderInfo.totalMoney" type="text" size="8" /></td>
  </tr>
  ...
  <tr>
    <td width=30%>付款方式:</td>
    <td width=70%><input id="orderInfo.buyWay" name="orderInfo.buyWay" type="text" size="20" /></td>
  </tr>

  <tr>
    <td width=30%>收货人姓名:</td>
    <td width=70%><input id="orderInfo.realName" name="orderInfo.realName" type="text" size="20" /></td>
  </tr>

  <tr>
    <td width=30%>收货人电话:</td>
    <td width=70%><input id="orderInfo.telphone" name="orderInfo.telphone" type="text" size="20" /></td>
  </tr>

  <tr>
    <td width=30%>邮政编码:</td>
    <td width=70%><input id="orderInfo.postcode" name="orderInfo.postcode" type="text" size="20" /></td>
  </tr>
  ...
  <tr>
    <td width=30%>附加信息:</td>
    <td width=70%><input id="orderInfo.memo" name="orderInfo.memo" type="text" size="50" /></td>
  </tr>
