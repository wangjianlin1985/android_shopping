				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new OrderInfoSimpleAdapter(OrderInfoListActivity.this, list,
	        					...
	        					new String[] { "orderNo","memberObj","orderTime","totalMoney","orderStateObj","realName","telphone" },
	        					new int[] { R.id.tv_orderNo,R.id.tv_memberObj,R.id.tv_orderTime,R.id.tv_totalMoney,R.id.tv_orderStateObj,R.id.tv_realName,R.id.tv_telphone,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < orderInfoList.size(); i++) {
				...
				map.put("memberObj", orderInfoList.get(i).getMemberObj());
				...
				map.put("realName", orderInfoList.get(i).getRealName());
				map.put("telphone", orderInfoList.get(i).getTelphone());
				list.add(map);
			}
		} catch (Exception e) { 
