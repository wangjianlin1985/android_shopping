...
import com.mobileclient.util.ActivityUtils;import com.mobileclient.util.OrderDetailSimpleAdapter;
...
public class OrderDetailListActivity extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == ActivityUtils.ADD_CODE && resultCode == RESULT_OK) {
        	queryConditionOrderDetail = null;
        	setViews();
        }
    }
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new OrderDetailSimpleAdapter(OrderDetailListActivity.this, list,
	        					R.layout.orderdetail_list_item,
	        					new String[] { "detailId","orderObj","productObj","price","count" },
	        					new int[] { R.id.tv_detailId,R.id.tv_orderObj,R.id.tv_productObj,R.id.tv_price,R.id.tv_count,},lv);
