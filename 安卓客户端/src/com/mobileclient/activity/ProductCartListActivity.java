...
import com.mobileclient.util.ActivityUtils;import com.mobileclient.util.ProductCartSimpleAdapter;
...
public class ProductCartListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(ProductCartListActivity.this, ProductCartQueryActivity.class);
				startActivityForResult(intent,ActivityUtils.QUERY_CODE);//此处的requestCode应与下面结果处理函中调用的requestCode一致
			}
		});
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("商品购物车查询列表");
		ImageView add_btn = (ImageView) this.findViewById(R.id.add_btn);
		add_btn.setOnClickListener(new android.view.View.OnClickListener(){ 
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(ProductCartListActivity.this, ProductCartAddActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==ActivityUtils.QUERY_CODE && resultCode==RESULT_OK){
        	...
        	if(extras != null)
        		queryConditionProductCart = (ProductCart)extras.getSerializable("queryConditionProductCart");
        	setViews();
        }
        ...
        if(requestCode == ActivityUtils.ADD_CODE && resultCode == RESULT_OK) {
        	queryConditionProductCart = null;
        	setViews();
        }
    }
	...
	private void setViews() {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new ProductCartSimpleAdapter(ProductCartListActivity.this, list,
	        					R.layout.productcart_list_item,
	        					new String[] { "cartId","memberObj","productObj","price","count" },
	        					new int[] { R.id.tv_cartId,R.id.tv_memberObj,R.id.tv_productObj,R.id.tv_price,R.id.tv_count,},lv);
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	Intent intent = new Intent();
            	intent.setClass(ProductCartListActivity.this, ProductCartDetailActivity.class);
	...
	private OnCreateContextMenuListener productCartListItemListener = new OnCreateContextMenuListener() {
		public void onCreateContextMenu(ContextMenu menu, View v,ContextMenuInfo menuInfo) {
			menu.add(0, 0, 0, "编辑商品购物车信息"); 
			menu.add(0, 1, 0, "删除商品购物车信息");
		}
	};
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑商品购物车信息
			...
			Intent intent = new Intent();
			intent.setClass(ProductCartListActivity.this, ProductCartEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putInt("cartId", cartId);
			intent.putExtras(bundle);
	...
	protected void dialog() {
		Builder builder = new Builder(ProductCartListActivity.this);
