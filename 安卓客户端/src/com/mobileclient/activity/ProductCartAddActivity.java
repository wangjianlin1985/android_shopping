			...
			public void onClick(View v) {
				try {
					...
					if(ET_price.getText().toString().equals("")) {
						Toast.makeText(ProductCartAddActivity.this, "商品单价输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_count.getText().toString().equals("")) {
						Toast.makeText(ProductCartAddActivity.this, "商品数量输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传商品购物车信息*/
					ProductCartAddActivity.this.setTitle("正在上传商品购物车信息，稍等...");
