...
import com.mobileclient.util.ActivityUtils;import com.mobileclient.util.MemberInfoSimpleAdapter;
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new MemberInfoSimpleAdapter(MemberInfoListActivity.this, list,
	        					R.layout.memberinfo_list_item,
	        					new String[] { "memberUserName","realName","sex","birthday","photo" },
	        					new int[] { R.id.tv_memberUserName,R.id.tv_realName,R.id.tv_sex,R.id.tv_birthday,R.id.iv_photo,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < memberInfoList.size(); i++) {
				...
				map.put("photo", HttpUtil.BASE_URL+ memberInfoList.get(i).getPhoto());
				list.add(map);
			}
		} catch (Exception e) { 
