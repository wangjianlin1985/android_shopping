...
import com.mobileclient.util.ActivityUtils;import com.mobileclient.util.YesOrNoSimpleAdapter;
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new YesOrNoSimpleAdapter(YesOrNoListActivity.this, list,
	        					R.layout.yesorno_list_item,
	        					new String[] { "id","name" },
	        					new int[] { R.id.tv_id,R.id.tv_name,},lv);
